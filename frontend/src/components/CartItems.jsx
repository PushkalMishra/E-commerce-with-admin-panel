    ...
    <section className='max_padd_container pt-28'>
                ...
                {all_products.map((e)=>{
                    if (cartItems[e.id]>0){
                        return <tr key={e.id} className='border-b border-slate-900/20 p-6 medium-14 text-center'>
                            <td className='flexCenter'><img src={e.image} alt="prdctImg" height={43} width={43} className='rounnded-lg ring-1 ring-slate-900/5 my-1'/></td>
        ...
        <div className='flex flex-col gap-20 my-16 p-8 md:flex-row rounded-md bg-white w-full max-w-[666px]'>
            <div className='flex flex-col gap-10'>
                ...
                <button className='btn_dark_rounded ww-44'>Checkout</button>
                <div className='flex flex-col gap-10'>
