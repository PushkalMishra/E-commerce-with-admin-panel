        ...
        <div className='flex-col flex xl:flex-[1.7]'>
            ...
            <div className='mb-4'>
                ...
                <div className='flex gap-3 my-3'>
                    ...
                    <div className='ring-2 ring-slate-900/10 h-10 w-10 flexCenetr cursor-pointer'>M</div>
                    <div className='ring-2 ring-slate-900/10 h-10 w-10 flexCeneter cursor-pointer'>L</div>
                    <div className='ring-2 ring-slat
                    e-900/10 h-10 w-10 flexCenter cursor-pointer'>XL</div>
                </div>
                <div className='fleex flex-col gap-y-3 mb-4 max-w-[555px]'>
                    <button onClick={()=>{addToCart(product.id)}} className='btn_drk_outline !rounded-none uppercase regular-14 tracking-widest'>Add to Cart</button>
