    ...
    <section className="max_padd_container py-12 xl:py-28">
      <div>
        ...
        <div className="flex items-center justify-between my-8 mx-2">
          ...
          <div className="flex items-center justify-between max-sm:p-4 gap-x-4 px-8 py-3 rounded-5xl ring-1 ring-slate-900/15">Sort by <MdOutlineKeyboardArrowDown/></div>
        </div>
